...
enum neutrino_system_call {
    NEUTRINO_SYSTEM_INFO = 2,
    NEUTRINO_EXIT = 3,
    NEUTRINO_SLEEP = 5,
    NEUTRINO_TIME_GET = 6,
    NEUTRINO_CLOCK_GET = 7,
    NEUTRINO_RANDOM_GET = 8,
    NEUTRINO_DESCRIPTOR_OPEN = 9,
    NEUTRINO_DESCRIPTOR_READ = 10,
    NEUTRINO_DESCRIPTOR_WRITE = 11,
    NEUTRINO_DESCRIPTOR_CLOSE = 12,
    NEUTRINO_FILE_OPEN = 19,
    NEUTRINO_FILE_OPEN_FLAGS = 20,
    NEUTRINO_FILE_CREATE = 22,
    NEUTRINO_FILE_CLOSE = 24,
    NEUTRINO_FILE_READ = 25,
    NEUTRINO_FILE_READ_AT = 26,
    NEUTRINO_FILE_WRITE = 27,
    NEUTRINO_FILE_SEEK = 28,
    NEUTRINO_FILE_STAT = 29,
    NEUTRINO_PATH_STAT = 30,
    NEUTRINO_FILE_SYNC = 31,
    NEUTRINO_FILE_REMOVE = 32,
    NEUTRINO_DIRECTORY_OPEN = 35,
    NEUTRINO_DIRECTORY_READ = 38,
    NEUTRINO_DIRECTORY_CLOSE = 39,
    NEUTRINO_DIRECTORY_CREATE = 40,
    NEUTRINO_DIRECTORY_REMOVE = 41,
    NEUTRINO_SYNC = 42,
    NEUTRINO_MAP_ANONYMOUS = 45,
    NEUTRINO_MAP_AT = 46,
    NEUTRINO_MAP_FILE_PRIVATE = 47,
    NEUTRINO_PROTECT_MEMORY = 48,
    NEUTRINO_UNMAP = 49,
    NEUTRINO_THREAD_CREATE = 50,
    NEUTRINO_THREAD_EXIT = 51,
    NEUTRINO_THREAD_JOIN = 52,
    NEUTRINO_THREAD_DETACH = 53,
    NEUTRINO_THREAD_ID = 54,
    NEUTRINO_FUTEX_WAIT = 57,
    NEUTRINO_FUTEX_WAIT_TIMED = 58,
    NEUTRINO_FUTEX_WAKE = 59,
